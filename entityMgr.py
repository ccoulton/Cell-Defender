...
class EntityMgr:
	...
	def init(self):
		...
		self.nDefenders = 0
		import ent
		self.entTypes = [ent.motherShip, ent.terrain, ent.defender, ent.attacker]
		self.terrainTypes = []
		self.rEnts = []
		self.terrain = []
	...
	def createTerrain(self, entType, pos = Vector3(0,0,0), yaw = 0):
		ent = self.createEnt(entType, pos, yaw)
		self.terrain.append(ent)
		return ent
